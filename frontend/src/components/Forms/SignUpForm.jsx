...
const SignUpForm = () => {
  ...
  return (
    <div className="w-full flex flex-col text-white gap-10 justify-center items-center pt-5 h-full ">
      <p className="font-bold  text-5xl orbitron text-center gradient-text utf">UTF 2k24</p>
      ...
      <form className="w-full" onSubmit={handleSubmit(signUp)}>
        ...
        <div className="space-y-5 cabin">
          ...
          <button
            ...
            className="button gradient-border bg-black text-white px-8 py-2 font-bold  disabled:bg-[#D3D3D3]"
            type="submit"
          >
