...
export const Sidebar = ({value}) => {
  ...
  return (
    ...
    <h1 className="font-extrabold md:text-left    font-REM text-3xl xs:absolute xs:top-0 md:relative" style={{color:"#FFbd00",transform:"translate(-50%,30%)",left:"50%" }}>EVENTS</h1>
