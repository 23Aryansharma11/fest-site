      ...
      <div className="bg-black bg-opacity-50 p-4 rounded-lg flex flex-col justify-center items-center">
        ...
        >
          <h1 className="text-2xl md:text-4xl font-light mb-4">
            WELCOME TO <span className=" gradient-text">UTF</span> 2024
          </h1>
        </motion.div>
        <motion.div
          initial={{ opacity: 1, x: 800, scale: 1 }}
        ...
        >
          <p className="text-lg md:text-2xl mb-8 w-full md:w-[40%] text-center mx-auto ">
            Explore our vibrant fest gallery showcasing the excitement of
            cultural activities, thrilling games, and intense coding contests!
            Experience the energy and creativity captured in every moment.
          </p>
        </motion.div>
      </div>
    </div>
